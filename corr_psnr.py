...
def calculate_correlation(values_4x, values_8x, values_16x, jnd_4x, jnd_8x, jnd_16x):
    corr_4x, _ = pearsonr(values_4x, jnd_4x)
    corr_8x, _ = pearsonr(values_8x, jnd_8x)
    corr_16x, _ = pearsonr(values_16x, jnd_16x)
    return corr_4x, corr_8x, corr_16x


psnr_corr_4x, psnr_corr_8x, psnr_corr_16x = calculate_correlation(
    psnr_4x, psnr_8x, psnr_16x, jnd_4x, jnd_8x, jnd_16x
)

print(f"PSNR vs JND correlation for 4x: {psnr_corr_4x}")
print(f"PSNR vs JND correlation for 8x: {psnr_corr_8x}")
print(f"PSNR vs JND correlation for 16x: {psnr_corr_16x}")
